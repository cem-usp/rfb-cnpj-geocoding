...
This report provides reproducible pipeline for processing, [geocoding](https://en.wikipedia.org/wiki/Address_geocoding), and classifying [CNPJ](https://en.wikipedia.org/wiki/CNPJ)s from the Brazilian Federal Revenue Service ([RFB](https://www.gov.br/receitafederal/)) using the [Locais-Nova](https://doi.org/10.1590/S2237-96222025v34.20240361.en) scale.
...
- Brazilian Federal Revenue Service ([RFB](https://www.gov.br/receitafederal/)):
  ...
  - Data on [Brazilian agencies and municipalities](https://dados.gov.br/dados/conjuntos-dados/tabela-de-rgos-e-municpios) (TOM).
...
- Center for Metropolitan Studies ([CEM](https://centrodametropole.fflch.usp.br/)): Lookup table providing the classification linking the establishments CNAEs (National Classification of Economic Activities) to the [Locais-Nova](https://doi.org/10.1590/S2237-96222025v34.20240361.en) groups. This data will remain private until further notice.
...
## Download IBGE Municipalities Data

```{r}
#| labels: Download IBGE Municipalities Data
...
establishment_data <-
  ...
  left_join(
    municipalities_data,
    by = c("federal_unit", "municipality_code"),
    suffix = c("", ".y")
  ) |>
  mutate(
...
metadata <-
  ...
  `var_label<-`(
    list(
      ...
      latitude = "Latitude",
      longitude = "Longitude",
      geocodebr_precision = "Precision value from geocodebr",
      geocodebr_type_of_result = "Result type from geocodebr",
      geocodebr_deviation_meters = "Deviation (meters) from geocodebr",
      geocodebr_address_found = "Address returned by geocodebr",
      geocodebr_ambiguous = "Ambiguous result from geocodebr",
      g0 = "Locais-Nova Group 0",
      g1_g2 = "Locais-Nova Groups 1 and 2",
      g3 = "Locais-Nova Group 3",
      g4 = "Locais-Nova Group 4"
    )
  ) |>
