...
Only establishments with an *Active* registration status (`$6 == "02"`) and no special status (`$29 == ""`) are included. The data is further filtered by municipality (`$21 == municipalities`).
:::
